...
ax.set_xlabel('Participant Number (ranked by maximum discomfort)', fontsize=12, color='black')
ax.set_ylabel('Subjective Discomfort Ratings', fontsize=12, color='black')
ax.set_title('Discomfort Range by Participant (n = 208)', fontsize=14, color='black')
